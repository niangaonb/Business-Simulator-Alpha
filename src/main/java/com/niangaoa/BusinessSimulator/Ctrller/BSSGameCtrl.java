...
public class BSSGameCtrl implements Initializable {
    @FXML private Text honor;
    @FXML private Text tired;
    @FXML private Text level;
    @FXML private Text xp;
    @FXML private Text hunger;
    @FXML private Text thinking;
    @FXML private GridPane gridPane;
    @FXML private Text storage;
    @FXML private Button write;
    @FXML private Button read;
    @FXML private Text have1;
    @FXML private Text have2;
    @FXML private Text have3;
    @FXML private Text have4;
    @FXML private Text have5;
    @FXML private Text have6;
    @FXML private Text have7;
    @FXML private Text have8;
    @FXML private Text have9;
    @FXML private Text have10;
    @FXML private Text have11;
    @FXML private Text have12;
